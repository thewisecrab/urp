...
- `examples/USE_CASES.md` for concrete object, AI, lakehouse, and audit scenarios;
- `docs/13_PLATFORM_READINESS.md` for the all-platform contract and live-credential readiness model;
- `docs/WHITE_PAPER.md` for the product thesis, architecture, safety model, evidence anchors, and current platform/live-credential boundaries.
